            ...
            <div className="max-w-md w-full bg-surface/80 backdrop-blur-sm rounded-2xl border border-border shadow-2xl p-8 space-y-6">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button 
                        type="submit" 
                        disabled={isLoading} 
                        className="w-full py-3 px-4 bg-primary text-white font-semibold rounded-md shadow-md 
                                   hover:bg-primary/80 hover:shadow-lg hover:scale-[1.02] 
                                   active:scale-[0.98] 
                                   transition-all duration-200 ease-in-out 
                                   disabled:bg-slate-500 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-md"
                    >
