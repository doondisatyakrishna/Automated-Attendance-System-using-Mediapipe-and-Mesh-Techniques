...
const Profile: React.FC = () => {
    const [profile, setProfile] = useState({
        ...
        email: '',
        phone: '',
        avatarUrl: 'https://cdn-icons-png.flaticon.com/512/847/847969.png', // default "no profile" icon
    });
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-base-100 p-6 rounded-xl shadow-soft border border-base-300/50 text-center">
                        ...
                        <label
                            ...
                            className="mt-4 inline-block bg-primary text-primary-content font-semibold px-4 py-2 rounded-lg cursor-pointer hover:bg-primary-focus transition-colors"
                        >
                            Change Picture
                        </label>
                        <input
                ...
                <div className="lg:col-span-2">
                    <form
                        ...
                        className="bg-base-100 p-6 rounded-xl shadow-soft border border-base-300/50"
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 bg-base-200 border border-base-300 rounded-lg focus:ring-primary focus:border-primary"
                                />
                            </div>
                            <div>
                        ...
                        <div className="mt-8 text-right">
                            <button
                                type="submit"
                                className="bg-primary hover:bg-primary-focus text-primary-content font-bold py-2 px-6 rounded-lg transition-colors"
                            >
                                Save Changes
                            </button>
                        </div>
