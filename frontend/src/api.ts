...
const getAuthHeaders = (contentType: string | null = 'application/json') => {
    ...
    if (!token) {
        // Handle case where token is missing, perhaps by redirecting to login
        console.error("Authentication token is missing.");
        // Depending on your app's logic, you might want to throw an error here
    }
...
// verifyAccountRequest remains the same
